...
app.post('/api/generate-multiple-reviews', async (req, res) => {
  ...
  language === 'Hindi'
    ...
    let seoKeywords = `
    “best dental clinic in Anand”, “painless root canal”, “tooth-colored filling”, “dental implant”, “smile designing”, "best dentist",
    `;
...
const toneMap = {
  ...
  Hindi: {
    ...
    'Dental treatment': { tone: 'एक शांत और संतुष्ट लहजा रखें, जिसमें नियमित जांच और देखभाल का जिक्र हो।', emoji: '😊' },
  ...
  Gujarati: {
    ...
    'Dental treatment': { tone: 'શાંત અને સંતોષકારક સ્વર રાખો, જેમાં નિયમિત તપાસ અને કાળજીનો ઉલ્લેખ હોય.', emoji: '😊' },
